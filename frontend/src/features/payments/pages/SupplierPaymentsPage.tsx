...
import { Search, RotateCcw, CreditCard, Eye, Pencil, Plus } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="md:hidden space-y-4 pb-16">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-neutral-900 tracking-tight">Payments Out</h1>
            <p className="text-neutral-500 text-xs mt-0.5">Payments made to suppliers</p>
          </div>
          <button
            ...
            <div className="flex gap-2 items-center">
              <div className="flex-1">
                <SearchableSelect
                  ...
                  options={[{ value: 'draft', label: 'Draft' }, { value: 'confirmed', label: 'Confirmed' }, { value: 'reversed', label: 'Reversed' }]}
                  value={status}
                  onChange={setStatus}
                />
              </div>
              <div className="bg-neutral-50/50 border border-neutral-200/60 rounded-xl px-3 py-1.5 flex flex-col items-end shrink-0 justify-center">
                ...
                <span className="text-xs font-bold text-neutral-800 tabular-nums mt-0.5">{formatCurrency(totalPaid)}</span>
              </div>
            </div>
          </div>
        </div>
              ...
              >
                <div className="rounded-[20px] bg-white p-3.5 space-y-3 shadow-[inset_0_1px_1px_rgba(255,255,255,1)]">
                  ...
                  <div className="flex justify-between items-center py-2 px-2.5 bg-neutral-50/50 rounded-xl border border-neutral-100/70 text-xs">
                    <div>
                      <p className="font-bold text-neutral-700">{p.supplier?.name || '-'}</p>
