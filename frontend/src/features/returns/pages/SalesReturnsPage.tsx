...
import { Search, RotateCcw, Undo2, Plus } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="md:hidden space-y-4 pb-16">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-neutral-900 tracking-tight">Sales Returns</h1>
            <p className="text-neutral-500 text-xs mt-0.5">Goods returned by customers</p>
          </div>
          <button
        ...
        {isLoading ? (
          ...
          <div className="text-center py-10 bg-white rounded-[24px] border border-neutral-200/50 p-6 space-y-2 shadow-sm">
            <Undo2 className="w-8 h-8 text-neutral-300 mx-auto" />
              ...
              >
                <div className="rounded-[20px] bg-white p-3.5 space-y-3 shadow-[inset_0_1px_1px_rgba(255,255,255,1)]">
                  ...
                  <div className="flex justify-between items-center py-2 px-2.5 bg-neutral-50/50 rounded-xl border border-neutral-100/70 text-xs">
                    <div>
                      <p className="font-bold text-neutral-700">{r.customer?.name || '-'}</p>
                      <p className="text-[10px] text-neutral-400 font-medium mt-0.5">Invoice: {r.invoice?.invoice_number || '-'}</p>
                    </div>
